...
const insertRealTimeDBRow = (tableID, type, dbData, db) => {
    ...
    newRow.insertCell(4).innerHTML = `<a href="javascript:deleteRowDB('${db}', '${tableID}', ${rowCount}, '${type}')"><i class="bi me-2 bi-trash"></i></a>`;
    newCellStyling(table, rowCount, 4, 'class', 'col-1 text-center');
    newCellTooltip(table, rowCount, 4, 'Delete', 'top');

    // newRow.insertCell(0).innerHTML = dbData[key];
    // newRow.insertCell(1).innerHTML = dbData[value];
    // newRow.insertCell(2).innerHTML = `<a href="javascript:deleteRowDB('${type}', '${tableID}', ${rowCount}, '${db}')"><i class="bi me-2 bi-trash"></i></a>`;
    // newCellStyling(table, rowCount, 1, 'class', 'col-1 text-center');
    // newCellTooltip(table, rowCount, 1, 'Delete', 'top');
}
