...
const server = 'https://db.ecoi.cloud:6984/'
...
async function createDefaultGraphs (start_dir, end_dir, url) {
    ...
    drawChartAvg('chartPm25LineHr', 'pm2.5', pm25Limit, retrieveUrl); // drawChart(div ID, Pollutant, Target Level, dbUrl)
    drawChartAvg('chartPm10LineHr', 'pm10', pm10Limit, retrieveUrl);
